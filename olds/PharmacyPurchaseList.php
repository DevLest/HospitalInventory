...
$query = "SELECT * FROM pharmacy_purchase_details";
            ...
            <div class="card mb-4" style="margin-left: 2%; width:96%;">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <label for="price" class="form-label" style="font-weight: bold; margin-left: 50%;">By Purchase Date:</label>
                        </div>
                        <div class="col-md-3">
    ...
    $(document).ready(function () {
        ...
        function filterTable() {
            ...
            $('#datatablesSimple tbody tr').each(function () {
                var rowInvoice = $(this).find('td:eq(2)').text().toLowerCase(); // Invoice column index
                var rowSupplier = $(this).find('td:eq(1)').text().toLowerCase(); // Supplier column index

                // Show or hide table row based on search criteria
                if (rowInvoice.includes(invoice) && rowSupplier.includes(supplier)) {
                    $(this).show();
                } else {
                    $(this).hide();
                }
        ...
        $('#invoiceSearch, #supplierSearch').on('input', filterTable);
