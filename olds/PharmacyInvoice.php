...
<div id="layoutSidenav_content">
    <div>
        <h1 style="margin-left: 3%; margin-top: 1%;"><i class="fas fa-file-invoice"></i> Create Invoice</h1>
        <p style="font-weight: bold; margin-left: 8%;">Create New Invoice</p>
    </div>
    <div class="container mt-1" style="opacity: 0.9; border-top: 2px solid black; margin-bottom: 50%;">
        <br>
        <form method="post" action="PharmacyAddMedProcess.php" style="margin-left: 10%;">
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="customerName" class="form-label">Medicine Name:</label>
            <input type="text" class="form-control" id="customerName" name="customerName" style="width: 100%;">
        </div>
        <div class="col-md-6 mb-3">
            <label for="contactNumber" class="form-label" style="margin-right: 20%;">Packing:</label>
            <input type="text" class="form-control" id="contactNumber" name="contactNumber" placeholder="Packing e.g 10 TAB" style="width: 50%;">
        </div>
    </div>
    <div class="mb-3">
        <label for="address" class="form-label">Generic Name:</label>
        <input type="text" class="form-control" id="address" name="address" style="width: 49%;">
    </div>
    <div class="mb-3">
        <label for="doctorName" class="form-label">Supplier:</label>
        <input type="text" class="form-control" id="doctorName" name="doctorName" style="width: 49%;">
    </div>
    <div>
    ...
    <div class="container mt-1" style="opacity: 0.9; border-top: 4px solid #5DADE2; width: 80%; margin-right: 20%;">
        <br>
        <button type="submit" class="btn btn-primary" style="margin-left: 80%;">ADD</button>
    </div>
</form><br>
<div class="head" style="opacity: 0.9; border-top: 2px solid black; margin-bottom: 50%;"></div>
