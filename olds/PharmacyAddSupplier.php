...
<div id="layoutSidenav_content">
    <div>
                <h1 style="margin-left: 3%; margin-top: 1%;"><i class="fas fa-truck"></i>     Add Supplier</h1>
                <p style="font-weight: bold; margin-left: 8%;">Add New Supplier</p>
            </div>
       <div class="container mt-1"  style="opacity: 0.9; border-top: 2px solid black;"><br>
        <h2 style="margin-left: 10%;">Supplier Form</h2>
        <form method="post" action="PharmacyProcessSupplier.php" style="margin-left: 10%;">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" required style="width: 50%;">
            </div>
            <div class="mb-3">
                <label for="address" class="form-label">contact_number</label>
               <input type="text" class="form-control" id="contact_number" name="contact_number" required style="width: 50%;">
            </div>
            <div class="mb-3">
                <label for="doctorName" class="form-label">address</label>
                <input type="text" class="form-control" id="address" name="address" rows="3" required style="width: 50%;">
            </div>
