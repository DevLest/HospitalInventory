...
$query = "SELECT * FROM pharmacy_suppliers";
...
<div id="layoutSidenav_content">
        <main>  
            <div>
                <h1 style="margin-left: 3%; margin-top: 1%;"><i class="fas fa-truck"></i>     Manage Supplier</h1>
                <p style="font-weight: bold; margin-left: 8%;">Manage Existing Supplier</p>
            </div>
