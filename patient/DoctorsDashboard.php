...
if (!isset($_SESSION['doctor_id']) || $_SESSION['specialties'] != 'Cardiology') {
    // Redirect to login if the user is not a cardiology doctor or not logged in
    header("Location: login.php?error=Access denied. Please log in as a Cardiology doctor.");
    exit();
}

// Your cardiology-specific content goes here
echo "Welcome, Dr. " . $_SESSION['name'] . " (Cardiology Specialist)";
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="row"> <!-- Use row class to create a horizontal group of columns -->
       <div class="col-xl-3 col-md-6">
        ...
        <?php
                ...
                // Query to fetch all appointments for doctors with the "Cardiology" specialty
                $dash_category_query = "
        ...
        // Query to fetch all pending appointments for doctors with the "𝖢𝖺𝗋𝖽𝗂𝗈𝗅𝗈𝗀𝗒" specialty
      ...
      <div class="col-xl-3 col-md-6">
        <div class="card text-white mb-4" style="background-color: #DCC7AA; opacity: 0.9; box-shadow: 0 2px 5px rgba(0, 0, 0, 1.9);">
         ...
         <?php
            ...
            // Query to fetch all approved appointments for doctors with the "𝖢𝖺𝗋𝖽𝗂𝗈𝗅𝗈𝗀𝗒" specialty
            ...
            if ($approved_appointments_query_run) {
                ...
                if ($approved_appointments_total > 0) {
                    ...
                    echo '<h4 class="mb-0" style="z-index: 2; position: relative; color: black;">𝖭𝗈 𝖠𝗉𝗉𝗋𝗈𝗏𝖾𝖽 𝖠𝗉𝗉𝗈𝗂𝗇𝗍𝗆𝖾𝗇𝗍𝗌</h4>';
                }
            } else {
       ...
       <?php
            ...
            // Query to fetch the total number of appointments for doctors with the "𝖢𝖺𝗋𝖽𝗂𝗈𝗅𝗈𝗀𝗒" specialty
            ...
            if ($total_appointments_query_run) {
                ...
                if ($total_appointments > 0) {
                    ...
                    echo '<h4 class="mb-0" style="z-index: 2; position: relative; color: black;">𝖭𝗈 𝖠𝗉𝗉𝗈𝗂𝗇𝗍𝗆𝖾𝗇𝗍𝗌</h4>';
                }
            } else {
                echo '<h4 class="mb-0" style="z-index: 2; position: relative;">Error fetching data</h4>';
            }
