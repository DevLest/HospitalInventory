<?php
session_name('RadiologySession');  // Ensure session name matches the one set during login
...
echo "Welcome, Dr. " . $_SESSION['name'] . " (Radiology Specialist)";
?>
<!DOCTYPE html>
<html lang="en">
<head>
       ...
       <div class="col-xl-3 col-md-6">
        <div class="card text-white mb-4" style="background-color: #DCC7AA; opacity: 0.9; box-shadow: 0 2px 5px rgba(0, 0, 0, 1.9);" >
         ...
         <?php
                ...
                // Define the specialty you want to filter by (e.g., Radiology)
                $specialty = 'Radiology';  // Example specialty

                // Query to fetch all appointments for doctors with the "Radiology" specialty
                $dash_category_query = "
                ...
                if ($appointments_total = mysqli_num_rows($dash_category_query_run)) {
                    ...
                    echo '<h4 class="mb-0" style="z-index: 2; position: relative;">No Data for Radiology</h4>';
                }
        ...
        // Query to fetch all pending appointments for doctors with the "Radiology" specialty
...
?>
      ...
      <div class="col-xl-3 col-md-6">
       ...
       <?php
            ...
            // Query to fetch all approved appointments for doctors with the "Radiology" specialty
       ...
       <?php
            ...
            // Query to fetch the total number of appointments for doctors with the "Radiology" specialty
