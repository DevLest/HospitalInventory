                ...
                <form method="POST" action="editpatient.php">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="hospitalnum" class="form-label">Hospital Number</label>
                            <input type="text" name="hospitalnum" class="form-control" value="<?php echo $row['hospitalnum']; ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="ext_name" class="form-control" value="<?php echo $row['ext_name']; ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="birthplace" class="form-control" value="<?php echo $row['birthplace']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="civilstatus" class="form-control" value="<?php echo $row['civilstatus']; ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="religion" class="form-control" value="<?php echo $row['religion']; ?>" required>
                        </div>
                    </div>
