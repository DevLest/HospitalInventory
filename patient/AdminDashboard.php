    ...
    <div>
                        ...
                        <div class="row">
                                ...
                                <div class="card bg-white text-black mb-4" style="height: 80%;">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div style="margin-left: 10px;">
                                            ...
                                            $dash_category_query = "SELECT * FROM pharmacy_cashier";
                                            $dash_category_query_run = mysqli_query($con, $dash_category_query);
                                ...
                                <div class="card bg-white text-black mb-4" style="height: 80%;">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div style="margin-left: 10px;">
                                            ...
                                            mysqli_close($con);
                                            ?>
                                            <span style="font-size: 1.0rem; font-weight: bold; color: #7F8C8D;">Outpatient Wards</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card bg-white text-black mb-4" style="height: 80%;">
                                    <div class="card-body d-flex align-items-center">
                                        ...
                                        <div style="margin-left: 10px;">
                                            ...
                                            $dash_category_query = "SELECT * FROM pharmacy_er_nurse";
                                            $dash_category_query_run = mysqli_query($con, $dash_category_query);
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-white text-black mb-4" style="height: 80%;">
                                    <div class="card-body d-flex align-items-center">
                                        <i class="fas fa-user fa-4x" style="color: #3498DB;"></i>
                                        <div style="margin-left: 10px;">
                                          <?php
                                            $host = 'localhost';
                                            $username = 'root';
                                            ...
                                            $dash_category_query = "SELECT * FROM pharmacycustomers";
                                            $dash_category_query_run = mysqli_query($con, $dash_category_query);
                                            ...
                                            mysqli_close($con);
                                            ?>
                                            <span style="font-size: 1.0rem; font-weight: bold; color: #7F8C8D;"> Customers</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
