                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $receiptTime = date('H:i:s', strtotime($row['created_at']));

                                // Add to overall total
                                $overall_total += $row['item_total'];

                                // Add to today's total if the receipt date is today
                                if (date('Y-m-d') == $receiptDate) {
                            ...
                            echo "<tr style='background-color: #f1f3f5; font-weight: bold;' id='today-total'>
                                    <td colspan='8' style='text-align: right;'>Total for Today's Receipts:</td>
                                    <td style='color: #28a745;'>₱ " . number_format($today_total, 2) . "</td>
                                  </tr>";
                        } else {
...
<script>
    function printReceipt() {
        ...
        var todayTotal = document.getElementById("today-total") ? document.getElementById("today-total").innerHTML : '';
