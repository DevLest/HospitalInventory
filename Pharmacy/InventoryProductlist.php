...
$sql = "SELECT * FROM pharmacy_products LIMIT $start_from, $records_per_page";
$result = $conn->query($sql);

// SQL query to get the total number of records
$total_records_sql = "SELECT COUNT(*) FROM pharmacy_products";
...
<div class="container mt-4">
    <div class="medicines-content-wrapper" style="width: 112%; margin-left: -67px;">
        <input type="text" id="searchInput" onkeyup="searchMedicine()" placeholder="Search for Product name..." class="form-control mb-3">
    ...
    <table id="medicines-table" class="table table-bordered">
        <thead>
            <tr>
                ...
                <th>Price</th>
                <th style="width: 9%;">Registered Quantity</th>
                <th style="width: 9%;">Sold Quantity</th>
                <th style="width: 9%;">Remain Quantity</th>
        ...
        <tbody>
            <?php if ($result->num_rows > 0): ?>
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        <td><img src="<?= $row["image"] ?>" alt="Product Image" class="img-fluid" style="max-width: 100px;"></td>
                        <td><?= $row["product"] ?></td>
                        <td><?= $row["category"] ?></td>
                        <td><?= $row["brand"] ?></td>
            ...
            <div class="modal-body">
                <form action="editproduct.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="date_registered" value="<?= $row["date_registered"] ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="registered_quantity" value="<?= $row["registered_quantity"] ?>">
                    </div>
