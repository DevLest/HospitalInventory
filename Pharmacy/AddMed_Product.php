...
<div class="first1" style="opacity: 0.9; border-top: 2px solid #b2babb; margin-top: -20px;"></div>
  ...
  <form action="add_medicine.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="medicineName" name="medicine_product" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="quantity" name="registered_quantity" required>
    </div>
    <div class="form-group">
